...
# Benchmark R vs merged Rcpp for dynIRT_KD
...
log_file <- "logs/rcpp_merged_benchmark.log"
sink(log_file, split = TRUE)

cat("Benchmark dynIRT_KD: R vs merged Rcpp\n")
...
saveRDS(out, file = "outputs/rcpp_merged_benchmark.rds")
