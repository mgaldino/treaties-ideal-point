...
```{r fig-investment, fig.cap="Investment ideal points (2D), 1990--2018. Anchors in red; tax havens in orange."}
knitr::include_graphics(here("outputs", "paper_figures", "fig_investment_2d.png"))
```

### Security

The security domain (Figure 2) exhibits a leftward drift in dim-1 means (from $-0.78$ to $-1.10$), suggesting that the distribution of alliance commitments has shifted away from the anchor-defined ILO-support pole. Nuclear powers occupy a range of positions along both dimensions, reflecting the diversity of their alliance portfolios.
...
```{r fig-environment, fig.cap="Environment ideal points (2D), 1990--2018. Anchors in red."}
...
```{r fig-human-rights, fig.cap="Human Rights ideal points (2D), 1990--2018. Anchors in red."}
...
```{r fig-arms-control, fig.cap="Arms Control ideal points (2D), 1990--2018. Anchors in red; nuclear powers in blue."}
...
```{r fig-ip, fig.cap="Intellectual Property ideal points (2D), 1990--2018. Anchors in red; tax havens in orange."}
...
**Table 5. Aggregate trends in dim-1 (anchor-defined ILO-support dimension), 1990--1994 vs. 2015--2018 (treaty domains) / 2019--2022 (trade)**
